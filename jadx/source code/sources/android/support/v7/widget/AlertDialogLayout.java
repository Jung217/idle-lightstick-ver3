...
public class AlertDialogLayout extends AbstractC0011a0 {
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            r7 = r2
        L73:
            java.util.WeakHashMap r8 = q.l.f728a
        ...
        if (mode2 != 1073741824) {
            ...
            while (i9 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) z2).width == -1) {
                        int i10 = ((ViewGroup.MarginLayoutParams) z2).height;
                        ((ViewGroup.MarginLayoutParams) z2).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i8, 0);
                        ((ViewGroup.MarginLayoutParams) z2).height = i10;
                    }
                }
                i9++;
